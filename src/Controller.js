import { getControllerPath, getFileNames, capitalize } from "./Utils.js";
...
export async function loadControllers() {
  getFileNames("controllers").forEach(async (controller) => {
    const controllerClass = await require(getControllerPath(controller));
